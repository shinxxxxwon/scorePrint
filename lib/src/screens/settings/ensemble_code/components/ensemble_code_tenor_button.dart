...
class EnsembleCodeTenorButton extends StatelessWidget {
  final Orientation? orientation;
  final bool? bIsTablet;
  final HttpCommunicate? httpCommunicate;

  EnsembleCodeTenorButton({this.orientation, this.bIsTablet, this.httpCommunicate});
    ...
    return Expanded(
      ...
      child: Consumer<EnsembleCodeProvider>(
        builder: (context, ensembleCode, child) {
          ...
          //   color: ensembleCode.nEnsembleCode == 1 ? Colors.deepPurpleAccent : Colors.grey,
          //   child: TextButton(
          //     onPressed: () => ensembleCode.changeEnsembleCode(1),
          //     child: Text(
          //       '테너',
          //       style: TextStyle(
          ...
          return GestureDetector(
            onTap: () async {
              // try {
              //   await ensembleCode.changeEnsembleCode(1);
              // }
              // catch(e){
              //   print('ensemble code tenor error : ${e.toString()}');
              // }
              // finally {
            ...
            //   alignment: Alignment.center,
              ...
              //     fit: BoxFit.fill,
              //     image: ensembleCode.nEnsembleCode == 1 ?
              //         AssetImage('assets/images/buttons/tenor_on_button.png') : AssetImage('assets/images/buttons/tenor_off_button.png'),
              //   ),
              // ),
              ///SJW Modify 2023.03.14 Start...
              ///버튼 이미지 깜빡임 수정
              child: Image.asset(
                ensembleCode.nEnsembleCode == 1 ? 'assets/images/buttons/tenor_on_button.png' : 'assets/images/buttons/tenor_off_button.png',
                fit: BoxFit.fill,
