...
import 'package:elfscoreprint_mobile/src/screens/phone/phone_main_screen.dart';

class DisplayLyricsNoneButton extends StatelessWidget {
  final Orientation? orientation;
  final bool? bIsTablet;
  final HttpCommunicate? httpCommunicate;

  DisplayLyricsNoneButton({this.orientation, this.bIsTablet, this.httpCommunicate});
    ...
    return Expanded(
      ...
      child: Consumer<DisplayLyricsProvider>(
        builder: (context, displayLyrics, child) {
          ...
          //   color: displayLyrics.nDisplayLyricsValue == 0 ? Colors.deepPurpleAccent : Colors.grey,
          //   child: TextButton(
          //     onPressed: () => displayLyrics.changeDisplayLyricsValue(0),
          //     child: Text(
          //       '안함',
          //       style: TextStyle(
          ...
          return GestureDetector(
            onTap: () async {
              ...
              // try {
              //   await displayLyrics.changeDisplayLyricsValue(0);
              // }
              // catch(e){
              //   print('display lyrics none error : ${e.toString()}');
              // }
              // finally {
            ...
            //   alignment: Alignment.center,
              ...
              //     fit: BoxFit.fill,
              //     image: displayLyrics.nDisplayLyricsValue == 0 ?
              ...
              ///버튼 이미지 깜빡임 수정
              child: Image.asset(
                displayLyrics.nDisplayLyricsValue == 0 ?  'assets/images/buttons/none_on_button.png' : 'assets/images/buttons/none_off_button.png',
                fit: BoxFit.fill,
