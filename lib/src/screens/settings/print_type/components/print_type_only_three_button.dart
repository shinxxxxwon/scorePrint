...
class PrintTypeOnlyThreeButton extends StatelessWidget {
  final Orientation? orientation;
  final bool? bIsTablet;
  final HttpCommunicate? httpCommunicate;

  PrintTypeOnlyThreeButton({this.orientation, this.bIsTablet, this.httpCommunicate});
    ...
    return Expanded(
      ...
      child: Consumer<PrintTypeProvider>(
        builder: (context, printType, child) {
          ...
          //   color: printType.nPrintTypeValue == 3 ? Colors.deepPurpleAccent : Colors.grey,
          //   child: TextButton(
          //     onPressed: () => printType.changePrintTypeValue(3),
          //     child: Text(
          //       '3보',
          //       style: TextStyle(
          ...
          return GestureDetector(
            onTap: () async {
              ...
              // try {
              //   await printType.changePrintTypeValue(3);
              // }
              // catch(e){
              //   print('print type only three error : ${e.toString()}');
              // }
              // finally {
            ...
            //   alignment: Alignment.center,
              ...
              //     fit: BoxFit.fill,
              //     image: printType.nPrintTypeValue == 3 ?
              //         AssetImage('assets/images/buttons/thirdboprint_on_button.png') : AssetImage('assets/images/buttons/thirdboprint_off_button.png'),
              //   ),
              // ),
              ///SJW Modify 2023.03.14 Start...
              ///버튼 이미지 깜빡임 수정
              child: Image.asset(
                printType.nPrintTypeValue == 3 ? 'assets/images/buttons/thirdboprint_on_button.png' : 'assets/images/buttons/thirdboprint_off_button.png',
                fit: BoxFit.fill,
