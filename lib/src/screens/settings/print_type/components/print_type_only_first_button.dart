...
class PrintTypeOnlyFirstButton extends StatelessWidget {
  final Orientation? orientation;
  final bool? bIsTablet;
  final HttpCommunicate? httpCommunicate;

  PrintTypeOnlyFirstButton({this.orientation, this.bIsTablet, this.httpCommunicate});
    ...
    return Expanded(
      ...
      child: Consumer<PrintTypeProvider>(
        builder: (context, printType, child) {
          ...
          //   color: printType.nPrintTypeValue == 1 ? Colors.deepPurpleAccent : Colors.grey,
          //   child: TextButton(
          //     onPressed: () => printType.changePrintTypeValue(1),
          //     child: Text(
          //       '1보',
          //       style: TextStyle(
          ...
          return GestureDetector(
            onTap: () async {
              ...
              // try {
              //   await printType.changePrintTypeValue(1);
              // }
              // catch(e){
              //   print('print type only first error : ${e.toString()}');
              // }
              // finally {
            ...
            //   alignment: Alignment.center,
              ...
              //     fit: BoxFit.fill,
              //     image: printType.nPrintTypeValue == 1 ?
              //         AssetImage('assets/images/buttons/firstboprint_on_button.png') : AssetImage('assets/images/buttons/firstboprint_off_button.png'),
              //   ),
              // ),
              ///SJW Modify 2023.03.14 Start...
              ///버튼 이미지 깜빡임 수정
              child: Image.asset(
                printType.nPrintTypeValue == 1 ? 'assets/images/buttons/firstboprint_on_button.png' : 'assets/images/buttons/firstboprint_off_button.png',
                fit: BoxFit.fill,
