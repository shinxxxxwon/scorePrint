...
class LyricsCommandmentsLyricsButton extends StatelessWidget {
  final Orientation? orientation;
  final bool? bIsTablet;
  final HttpCommunicate? httpCommunicate;

  LyricsCommandmentsLyricsButton({this.orientation, this.bIsTablet, this.httpCommunicate});
    ...
    return Expanded(
      ...
      child: Consumer<LyricsCommandmentsProvider>(
        builder: (context, lyricsCommandments, child) {
          ...
          //   color: lyricsCommandments.nLyricsCommandmentsValue == 0 ? Colors.deepPurpleAccent : Colors.grey,
          //   child: TextButton(
          //     onPressed: () => lyricsCommandments.changeLyricsCommandmentsValue(0),
          //     child: Text(
          //       '가사',
          //       style: TextStyle(
          ...
          return GestureDetector(
            onTap: () async {
              ...
              // try {
              //   // await lyricsCommandments.changeLyricsCommandmentsValue(0);
              //   Future.wait([lyricsCommandments.changeLyricsCommandmentsValue(0)]);
              // }
              // catch(e){
              //   print('lyrics commandments lyrics error : ${e.toString()}');
              // }
              // finally {
            ...
            //   alignment: Alignment.center,
              ...
              //     fit: BoxFit.fill,
              //     image: lyricsCommandments.nLyricsCommandmentsValue == 0 ?
              //         AssetImage('assets/images/buttons/lyrics_on_button.png') : AssetImage('assets/images/buttons/lyrics_off_button.png'),
              //   ),
              // ),
              ///SJW Modify 2023.03.14 Start...
              ///버튼 이미지 깜빡임 수정
              child: Image.asset(
                lyricsCommandments.nLyricsCommandmentsValue == 0 ? 'assets/images/buttons/lyrics_on_button.png' : 'assets/images/buttons/lyrics_off_button.png',
                fit: BoxFit.fill,
