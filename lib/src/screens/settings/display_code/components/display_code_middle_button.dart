...
class DisplayCodeMiddleButton extends StatelessWidget {
  final Orientation? orientation;
  final bool? bIsTablet;
  final HttpCommunicate? httpCommunicate;

  DisplayCodeMiddleButton({this.orientation, this.bIsTablet, this.httpCommunicate});
    ...
    return Expanded(
      ...
      child: Consumer<DisplayCodeProvider>(
        builder: (context, displayCode, child) {
          ...
          //   color: displayCode.nDisplayCodeValue == 2 ? Colors.deepPurpleAccent : Colors.grey,
          //   child: TextButton(
          //     onPressed: () => displayCode.changeDisplayCodeValue(2),
          //     child: Text(
          //       '중',
          //       style: TextStyle(
          ...
          return GestureDetector(
            onTap: () async {
              ...
              // try {
              //   await displayCode.changeDisplayCodeValue(2);
              // }
              // catch(e){
              //   print('displaycode middle error : ${e.toString()}');
              // }
              // finally {
            ...
            //   alignment: Alignment.center,
              ...
              //     fit: BoxFit.fill,
              //     image: displayCode.nDisplayCodeValue == 2 ? displayCode.middleOnButton : displayCode.middleOffButton,
              ...
              ///버튼 이미지 깜빡임 수정
              child: Image.asset(
                displayCode.nDisplayCodeValue == 2 ?  'assets/images/buttons/middle_on_button.png' : 'assets/images/buttons/middle_off_button.png',
                fit: BoxFit.fill,
