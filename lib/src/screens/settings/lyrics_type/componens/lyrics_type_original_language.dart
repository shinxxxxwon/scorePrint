...
class LyricsTypeOriginalLanguage extends StatelessWidget {
  final Orientation? orientaion;
  final bool? bIsTablet;
  final HttpCommunicate? httpCommunicate;

  LyricsTypeOriginalLanguage({this.orientaion, this.bIsTablet, this.httpCommunicate});
    ...
    return Expanded(
      ...
      child: Consumer<LyricsTypeProvider>(
        builder: (context, lyricsType, child) {
          ...
          //   color: lyricsType.nLyricsTypeValue == 0 ? Colors.deepPurpleAccent : Colors.grey,
          //   child: TextButton(
          //     onPressed: () => lyricsType.changeLyricsTypeValue(0),
          //     child: Text(
          //       '원어',
          //       style: TextStyle(
          ...
          return GestureDetector(
            onTap: () async {
              ...
              // try {
              //   await lyricsType.changeLyricsTypeValue(0);
              // }
              // catch(e){
              //   print('lyrics type original language error : ${e.toString()}');
              // }
              // finally {
            ...
            //   alignment: Alignment.center,
              ...
              //     fit: BoxFit.fill,
              //     image: lyricsType.nLyricsTypeValue == 0 ?
              //         AssetImage('assets/images/buttons/original_on_button.png') : AssetImage('assets/images/buttons/original_off_button.png'),
              //   ),
              // ),
              ///SJW Modify 2023.03.14 Start...
              ///버튼 이미지 깜빡임 수정
              child: Image.asset(
                lyricsType.nLyricsTypeValue == 0 ? 'assets/images/buttons/original_on_button.png' : 'assets/images/buttons/original_off_button.png',
                fit: BoxFit.fill,
