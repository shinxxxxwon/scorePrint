...
class TranspositionText extends StatelessWidget {
  final Orientation? orientation;
  final bool? bIsTablet;

  TranspositionText({this.orientation, this.bIsTablet});
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      ...
      child: Container(
        width: _size.width,
        height: orientation == Orientation.portrait ? _size.height * 0.05 : _size.height * 0.05,
